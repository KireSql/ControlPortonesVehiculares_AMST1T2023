...
public class ListaUsuarios extends AppCompatActivity {
    ...
    public void cerrarSesion() {
        ...
        Intent intent = new Intent(ListaUsuarios.this, InicioSesion.class);
    ...
    public void regresarInicio() {
        ...
        Intent intent = new Intent(ListaUsuarios.this, EditarCiudadelas.class);
        startActivity(intent);
    }

    public void mensajes() {
        // Redirigir a la actividad Ciudadelas
        Intent intent = new Intent(ListaUsuarios.this, Mensajes.class);
        startActivity(intent);
    }

    public void perfil() {
        // Redirigir a la actividad Perfil Usuario
        Intent intent = new Intent(ListaUsuarios.this, PerfilUsuario.class);
        startActivity(intent);
    }

    public void usuarios() {
        // Redirigir a la actividad Ciudadelas
        Intent intent = new Intent(ListaUsuarios.this, ListaUsuarios.class);
        startActivity(intent);
    }
}